...
const NotFound = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F8FAFC] p-6 text-slate-900 font-sans">
      {/* Header with Logo */}
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-md w-full text-center space-y-10">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-black tracking-tighter text-slate-900 uppercase">Node Disconnected.</h1>
